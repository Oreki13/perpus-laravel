...
<div class='h-screen flex justify-center items-center'>
    <div class='w-1/3 border shadow-md px-5 py-3 rounded'>
        <h1 class='text-center text-2xl'>Add Admin</h1>
        <form class='mt-3' action="{{ route('addAdmin.post') }}" method="POST">
            @csrf
            ...
            <button
                class='mt-3 bg-blue-500 w-full rounded p-2 text-white text-center hover:bg-blue-700 transition-all duration-200'>Add admin</button>
        </form>
